...
public class WebController implements WebMvcConfigurer {
	 ...
	 *
	 * @author FUTURE KUSHKI ENGINEER Jacob Orellana<br> jacobore@hotmail.com<br>
	 * 
	 * @date 18/07/2021
	 * 
	 * @version 1.0
	...
	public String cashOut(@Valid Gambler gambler, @RequestParam(value = "action", required = false) String action,
			BindingResult bindingResult) {

		System.out.println("CREDITOS: " + gambler.getCreditos());
